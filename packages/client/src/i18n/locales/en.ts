export default {
  ...
  settings: {
    ...
    display: {
      ...
      themeDark: 'Dark',
      themeSystem: 'System',
      taTitle: 'Thinking Animation',
      taHint: 'Upload a custom animation to replace the default thinking indicator',
      taNoCustom: 'Using default animation',
      taUpload: 'Upload Animation',
      taReplace: 'Replace',
      taReset: 'Reset to Default',
      taResetSuccess: 'Reset to default animation',
      taResetFailed: 'Failed to reset animation',
      taUploadSuccess: 'Animation uploaded successfully',
      taUploadFailed: 'Upload failed',
      taTooLarge: 'File too large (max 100MB)',
      taUnsupportedFormat: 'Unsupported format. Use GIF, MP4, WebM, MOV, AVI, or MKV',
      taSupportedFormats: 'Supported: GIF, MP4, WebM (native) · MOV, AVI, MKV (requires ffmpeg)',
