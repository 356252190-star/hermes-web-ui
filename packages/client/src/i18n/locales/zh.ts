export default {
  ...
  settings: {
    ...
    display: {
      ...
      themeSystem: '跟随系统',
      taTitle: '思考动画',
      taHint: '上传自定义动画替换默认的思考指示器',
      taNoCustom: '使用默认动画',
      taUpload: '上传动画',
      taReplace: '替换',
      taReset: '恢复默认',
      taResetSuccess: '已恢复默认动画',
      taResetFailed: '重置失败',
      taUploadSuccess: '动画上传成功',
      taUploadFailed: '上传失败',
      taTooLarge: '文件太大（最大 100MB）',
      taUnsupportedFormat: '不支持的格式，请使用 GIF、MP4、WebM、MOV、AVI 或 MKV',
      taSupportedFormats: '支持格式：GIF、MP4、WebM（原生）· MOV、AVI、MKV（需要 ffmpeg）',
