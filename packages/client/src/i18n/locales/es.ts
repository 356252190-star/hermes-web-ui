export default {
  ...
  gatewayTabs: {
    ...
    delete: 'Eliminar',
    create: 'Crear perfil',
    nameRequired: 'Se requiere nombre de perfil',
    ...
    avatar: {
    user: 'Avatar de usuario',
    assistant: 'Avatar de IA',
    changeUserAvatar: 'Cambiar avatar de usuario',
    changeAiAvatar: 'Cambiar avatar de IA',
    cropTitle: 'Recortar avatar',
    cropConfirm: 'Aplicar',
    uploadSuccess: 'Avatar actualizado',
    uploadFailed: 'Error al subir',
    fileTooLarge: 'Archivo demasiado grande (máx. 5 MB)',
    invalidType: 'Formato no soportado. Use PNG, JPG, GIF o WebP',
  },
}
