export default {
  ...
  settings: {
    ...
    display: {
      ...
      themeDark: 'Oscuro',
      themeSystem: 'Sistema',
      taTitle: 'Animación de pensamiento',
      taHint: 'Sube una animación personalizada para reemplazar el indicador de pensamiento predeterminado',
      taNoCustom: 'Usando animación predeterminada',
      taUpload: 'Subir animación',
      taReplace: 'Reemplazar',
      taReset: 'Restablecer',
      taResetSuccess: 'Restablecido a animación predeterminada',
      taResetFailed: 'Error al restablecer',
      taUploadSuccess: 'Animación subida correctamente',
      taUploadFailed: 'Error al subir',
      taTooLarge: 'Archivo demasiado grande (máx 100MB)',
      taUnsupportedFormat: 'Formato no soportado. Usa GIF, MP4, WebM, MOV, AVI o MKV',
      taSupportedFormats: 'Soportado: GIF, MP4, WebM (nativo) · MOV, AVI, MKV (requiere ffmpeg)',
