export default {
  ...
  settings: {
    ...
    display: {
      ...
      themeSystem: '시스템',
      taTitle: '사고 애니메이션',
      taHint: '기본 사고 인디케이터를 대체할 커스텀 애니메이션 업로드',
      taNoCustom: '기본 애니메이션 사용 중',
      taUpload: '애니메이션 업로드',
      taReplace: '교체',
      taReset: '기본값으로 복원',
      taResetSuccess: '기본 애니메이션으로 리셋됨',
      taResetFailed: '리셋 실패',
      taUploadSuccess: '애니메이션 업로드 성공',
      taUploadFailed: '업로드 실패',
      taTooLarge: '파일이 너무 큽니다 (최대 100MB)',
      taUnsupportedFormat: '지원되지 않는 형식입니다. GIF, MP4, WebM, MOV, AVI, MKV를 사용하세요',
      taSupportedFormats: '지원: GIF, MP4, WebM (네이티브) · MOV, AVI, MKV (ffmpeg 필요)',
