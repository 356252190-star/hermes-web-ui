export default {
  ...
  settings: {
    ...
    display: {
      ...
      themeSystem: 'システム',
      taTitle: '思考アニメーション',
      taHint: 'デフォルトの思考インジケーターを置き換えるカスタムアニメーションをアップロード',
      taNoCustom: 'デフォルトアニメーションを使用中',
      taUpload: 'アニメーションをアップロード',
      taReplace: '置き換え',
      taReset: 'デフォルトに戻す',
      taResetSuccess: 'デフォルトアニメーションにリセットしました',
      taResetFailed: 'リセットに失敗しました',
      taUploadSuccess: 'アニメーションのアップロードに成功しました',
      taUploadFailed: 'アップロードに失敗しました',
      taTooLarge: 'ファイルが大きすぎます（最大100MB）',
      taUnsupportedFormat: 'サポートされていない形式です。GIF、MP4、WebM、MOV、AVI、MKVを使用してください',
      taSupportedFormats: '対応：GIF、MP4、WebM（ネイティブ）· MOV、AVI、MKV（ffmpegが必要）',
