export default {
  ...
  gatewayTabs: {
    ...
    created: 'プロファイル作成しました',
    createFailed: 'プロファイルの作成に失敗しました',
    renamed: '名前変更しました',
    renameFailed: '名前の変更に失敗しました',
    deleted: 'プロファイル削除しました',
    deleteFailed: 'プロファイルの削除に失敗しました',
    exported: 'エクスポートしました',
    exportFailed: 'エクスポートに失敗しました',
    cannotDeleteActive: 'アクティブなプロファイルは削除できません',
    ...
    user: 'ユーザーアバター',
    assistant: 'AIアバター',
    changeUserAvatar: 'ユーザーアバターを変更',
    changeAiAvatar: 'AIアバターを変更',
    cropTitle: 'アバターを切り抜く',
    cropConfirm: '適用',
    uploadSuccess: 'アバターを更新しました',
    uploadFailed: 'アップロードに失敗しました',
    fileTooLarge: 'ファイルが大きすぎます（最大5MB）',
    invalidType: 'サポートされていない形式です。PNG、JPG、GIF、WebPを使用してください',
  },
}
