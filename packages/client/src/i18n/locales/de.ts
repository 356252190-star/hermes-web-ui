export default {
  ...
  gatewayTabs: {
    ...
    delete: 'Löschen',
    create: 'Profil erstellen',
    nameRequired: 'Profilname erforderlich',
    ...
    user: 'Benutzeravatar',
    assistant: 'KI-Avatar',
    changeUserAvatar: 'Benutzeravatar ändern',
    changeAiAvatar: 'KI-Avatar ändern',
    cropTitle: 'Avatar zuschneiden',
    cropConfirm: 'Anwenden',
    uploadSuccess: 'Avatar aktualisiert',
    uploadFailed: 'Upload fehlgeschlagen',
    fileTooLarge: 'Datei zu groß (max. 5 MB)',
    invalidType: 'Nicht unterstütztes Format. Verwenden Sie PNG, JPG, GIF oder WebP',
  },
}
