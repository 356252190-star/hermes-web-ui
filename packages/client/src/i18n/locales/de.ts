export default {
  ...
  settings: {
    ...
    display: {
      ...
      themeDark: 'Dunkel',
      themeSystem: 'System',
      taTitle: 'Denk-Animation',
      taHint: 'Laden Sie eine benutzerdefinierte Animation hoch, um den Standard-Denkindikator zu ersetzen',
      taNoCustom: 'Standard-Animation wird verwendet',
      taUpload: 'Animation hochladen',
      taReplace: 'Ersetzen',
      taReset: 'Auf Standard zurücksetzen',
      taResetSuccess: 'Auf Standard-Animation zurückgesetzt',
      taResetFailed: 'Zurücksetzen fehlgeschlagen',
      taUploadSuccess: 'Animation erfolgreich hochgeladen',
      taUploadFailed: 'Upload fehlgeschlagen',
      taTooLarge: 'Datei zu groß (max. 100MB)',
      taUnsupportedFormat: 'Nicht unterstütztes Format. Verwenden Sie GIF, MP4, WebM, MOV, AVI oder MKV',
      taSupportedFormats: 'Unterstützt: GIF, MP4, WebM (nativ) · MOV, AVI, MKV (benötigt ffmpeg)',
