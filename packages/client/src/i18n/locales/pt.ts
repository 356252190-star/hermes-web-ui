export default {
  ...
  gatewayTabs: {
    ...
    delete: 'Excluir',
    create: 'Criar perfil',
    nameRequired: 'Nome do perfil obrigatório',
    ...
    assistant: 'Avatar da IA',
    changeUserAvatar: 'Alterar avatar do usuário',
    changeAiAvatar: 'Alterar avatar da IA',
    cropTitle: 'Cortar avatar',
    cropConfirm: 'Aplicar',
    uploadSuccess: 'Avatar atualizado',
    uploadFailed: 'Falha no upload',
    fileTooLarge: 'Arquivo muito grande (máx. 5 MB)',
    invalidType: 'Formato não suportado. Use PNG, JPG, GIF ou WebP',
  },
}
