export default {
  ...
  settings: {
    ...
    display: {
      ...
      themeDark: 'Escuro',
      themeSystem: 'Sistema',
      taTitle: 'Animação de pensamento',
      taHint: 'Carregue uma animação personalizada para substituir o indicador de pensamento padrão',
      taNoCustom: 'Usando animação padrão',
      taUpload: 'Carregar animação',
      taReplace: 'Substituir',
      taReset: 'Redefinir',
      taResetSuccess: 'Redefinido para animação padrão',
      taResetFailed: 'Falha ao redefinir',
      taUploadSuccess: 'Animação carregada com sucesso',
      taUploadFailed: 'Falha ao carregar',
      taTooLarge: 'Arquivo muito grande (máx 100MB)',
      taUnsupportedFormat: 'Formato não suportado. Use GIF, MP4, WebM, MOV, AVI ou MKV',
      taSupportedFormats: 'Suportado: GIF, MP4, WebM (nativo) · MOV, AVI, MKV (requer ffmpeg)',
