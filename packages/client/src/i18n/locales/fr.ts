export default {
  ...
  settings: {
    ...
    display: {
      ...
      themeDark: 'Sombre',
      themeSystem: 'Systeme',
      taTitle: 'Animation de réflexion',
      taHint: 'Téléchargez une animation personnalisée pour remplacer l'indicateur de réflexion par défaut',
      taNoCustom: 'Animation par défaut utilisée',
      taUpload: 'Télécharger l'animation',
      taReplace: 'Remplacer',
      taReset: 'Réinitialiser',
      taResetSuccess: 'Réinitialisé à l'animation par défaut',
      taResetFailed: 'Échec de la réinitialisation',
      taUploadSuccess: 'Animation téléchargée avec succès',
      taUploadFailed: 'Échec du téléchargement',
      taTooLarge: 'Fichier trop volumineux (max 100Mo)',
      taUnsupportedFormat: 'Format non supporté. Utilisez GIF, MP4, WebM, MOV, AVI ou MKV',
      taSupportedFormats: 'Supporté : GIF, MP4, WebM (natif) · MOV, AVI, MKV (nécessite ffmpeg)',
