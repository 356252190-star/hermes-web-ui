export default {
  ...
  gatewayTabs: {
    ...
    assistant: 'Avatar IA',
    changeUserAvatar: "Changer l'avatar utilisateur",
    changeAiAvatar: "Changer l'avatar IA",
    cropTitle: "Recadrer l'avatar",
    ...
    invalidType: 'Format non pris en charge. Utilisez PNG, JPG, GIF ou WebP',
  },
}
